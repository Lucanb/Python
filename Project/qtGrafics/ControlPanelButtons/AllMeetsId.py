...
class MeetAfterId(QWidget):
    ...
    ---------
    username : str
        It represents our username and it is used too se what are our invites or meets
    ...
    def __init__(self,username):
        ...
        ----------
        username : str
            Is used for verifing the meets where I am invited or where I am the host.
        """
    ...
    def selectTimes(self):
        ...
        try:
            ...
            print(MyId)
            results = meets.getMeetsInvitationsById(MyId)
            print(results)
